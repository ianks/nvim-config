return {
  ...
  config = function()
    ...
    map({ "n", "t" }, "<M-h>", function() require("smart-splits").move_cursor_left() end, { desc = "Move to left split" })
    map({ "n", "t" }, "<M-j>", function() require("smart-splits").move_cursor_down() end, { desc = "Move to lower split" })
    map({ "n", "t" }, "<M-k>", function() require("smart-splits").move_cursor_up() end, { desc = "Move to upper split" })
    map({ "n", "t" }, "<M-l>", function() require("smart-splits").move_cursor_right() end, { desc = "Move to right split" })
